...
<!-- banner -->
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products.php" method="post">
 		<input type="number"   name="spid" placeholder="Enter product id"/><br>
 		<input type="text"   name="scategory" placeholder="Enter Category"/><br>
		<input type="text"   name="sitem_name" placeholder="Enter Item name"/><br>
		<input type="number"   name="scost" placeholder="Enter Cost"/><br>
      	<input type="submit" name="submit" value="Search For products"/>
    </form>
      <?php echo "</td>";
      echo "</tr>";
...
<div id="search_products_itname">
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products_itname.php" method="post">
		<h3>Search for the products based on item name:</h3>
		<input type="text"   name="sitem_name" placeholder="enter Item name"/><br>
      	<input type="submit" name="submit" class="submit" value="Search"/><hr>
    </form>
      <?php echo "</td>";
      echo "</tr>";
  ...
  $db="grocery";
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
	  ...
	  <h3>Search for products based on price range</h3>
		...
		<input type="number"   name="sitem_price_st" placeholder="Enter least cost"/><br>
		<input type="number"   name="sitem_price_end" placeholder="Enter highest cost"/><br>
      	<input type="submit" name="submit" class="submit" value="search"/><hr>
    </form>
      <?php echo "</td>";
      echo "</tr>";
  ...
  $db="grocery";
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products_itsort.php" method="post">
      	<input type="submit" name="submit" class="submit1" value="Sort products Based on Item Price"/><hr>
    </form>
      <?php echo "</td>";
      echo "</tr>";
