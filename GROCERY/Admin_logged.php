...
<style>
	...
	input{
		...
		&:active, &:hover, &:focus{
			...
			transition: box-shadow .3x linear;
		}
	}
	input.submit1{
		width: 200px;
...
<center><h1> PRODUCTS</h1></center>
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      echo "<th>"; echo "catogery";echo "&nbsp"; echo "</th>";
...
?>
 ...
 echo "</center>";
      ...
      <form action="add_products.php" method="post">
 		...
 		<input type="text" placeholder="category" name="p_catogery"/>
 		<input type="text" placeholder="Item_name" name="p_Item_name"/>
 		<input type="number" placeholder="Cost" name="p_cost"/>
      	<input type="number" placeholder="no_of_items" name="p_items"/>
	...
	<input type="number" placeholder="Enter product id" name="cpid">
...
<div id="customer">
   ...
   $query = mysqli_query($connect,"SELECT * FROM customer");
      ...
      echo "<th>"; echo "Username";echo "&nbsp";echo "&nbsp"; echo "</th>";
 ...
 while ($row = mysqli_fetch_array ($query)) {
     ...
     // echo "<td>"; echo $row["password"]; echo "</td>";
      ...
      ?><form action="A_update_customer.php" method="post">
		...
		<input type="text" placeholder="<?php echo $row["Email"];?>" value="<?php echo $row["Email"];?>" name="C_Email"/>
  ...
  echo "<tr>";
	  ...
	  <form action="add_employee.php" method="post">
 		...
 		<input type="number" placeholder="Phone Number" name="e_phone_no"/>
      	<input type="submit" name="submit" class="submit" value="Add Employee"/>
    </form><br><br>
	<!--<h4>Delete employee:</h4>
	<form action="delete_employee.php" method="post">
	<input type="number" placeholder="Enter employee id" name="eid">
...
<br><br><br><center><h1>All transactions</h1></center>
   ...
   $Cart_total=0;
      ...
      ?><table cellpadding="5" cellspacing="5">
         <?php
      echo "<tr>";
      echo "<th>"; echo "Customer ID";echo "&nbsp";echo "&nbsp"; echo "</th>";
      echo "<th>"; echo "Product ID";echo "&nbsp";echo "&nbsp"; echo "</th>";
...
<div id="search_products">
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products.php" method="post">
 		...
 		<input type="text"   name="scategory" placeholder="category"/><br><br>
		<input type="text"   name="sitem_name" placeholder="item name"/><br><br>
		<input type="number"   name="scost" placeholder="cost"/><br><br>
      	<input type="submit" name="submit"class="submit2" value="Search For products"/><br><br><br>
    </form>
      <?php echo "</td>";
      echo "</tr>";
...
<div id="search_products_itname">
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
	  ...
	  <form action="search_products_itname.php" method="post">
		<h3>Search for products based on item name:</h3>
		<input type="text" placeholder="Enter item name"  name="sitem_name"/><br><br>
      	<input type="submit" name="submit" class="submit2" value="Search"/><br><br>
    </form>
      <?php echo "</td>";
      echo "</tr>";
  ...
  $db="grocery";
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products_range.php" method="post">
		<h3>Search for products based on price range:</h3>
		<input type="number" placeholder="Enter least cost"  name="sitem_price_st"/><br><br>
		<input type="number"  placeholder="Enter highest cost" name="sitem_price_end"/><br><br>
      	<input type="submit" name="submit"class="submit2" value="Search"/><br><br>
    </form>
      <?php echo "</td>";
      echo "</tr>";
  ...
  $db="grocery";
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
      ...
      ?><form action="search_products_itsort.php" method="post"><br>
      	<input type="submit" name="submit" class="submit3" value="Sort products Based on Item Price"/>
    </form><br><br>
      <?php echo "</td>";
      echo "</tr>";
