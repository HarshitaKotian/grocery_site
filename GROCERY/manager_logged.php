...
<center><h1>Products</h1></center>
   ...
   $query = mysqli_query($connect,"SELECT * FROM products");
    ...
    $var=" ";
      echo "<center>";
      ?><thead><table cellpadding="5" cellspacing="5">
      	<?php
		
      echo "<tr>";
	  
      echo "<th>"; echo "Product ID" ; echo "\t";echo "</th>";
 ...
 while ($row = mysqli_fetch_array ($query)) {
      ...
      ?><form action="update_products.php" method="post">
		 ...
		 <input type="number" placeholder="Cost" name="cost_of_item"/> &#160;
		 <input type="number" placeholder="No_of_items" name="current_no_of_items"/>
...
?>
	...
	<br>
	<br>
	<center><h1>All Purchases</h1></center>
